                         ...
                         <tr>
                              ...
                              <td style="width: 10px;">
                                   ...
                                   <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Day/s">
                                        <a href="#days_edit<?php echo $faculty_allowed_days_id;?>" type="button"
                                             class="btn btn-info text-white" data-bs-toggle="modal"
                                             data-bs-target="#days_edit<?php echo $faculty_allowed_days_id;?>">
                              ...
                              <!-- Modal -->
                              <div class="modal fade" id="days_edit<?php echo $faculty_allowed_days_id;?>" tabindex="-1"
